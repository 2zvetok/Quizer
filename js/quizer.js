...
function chooseKaraoke(){
	toggleGameButton();
	let guess = $('#answer_input').val();
	let answer = songs[song_count].line;
	let isCorrect = guess.toUpperCase() == answer.toUpperCase();
	if(isCorrect){
		mirror_eval(answer, 20, "green");
		correct++;
		$('#rate').html(rate = '<br/>+ ' + songs[song_count].song + rate);
	} else {	
		if(window.confirm('Верный ответ: "' + answer + '". Засчитать Ваш ответ?')){
			mirror_eval(answer, 20, "green");
			correct++;
			$('#rate').html(rate = '<br/>+ ' + songs[song_count].song + rate);
		} else {
			mirror_eval(answer, 20, "red");
			$('#skill').html(skill = '<br/>- ' + songs[song_count].song + skill);
		}
	}
	next();
}
...
let ru_2010_m = [
	...
	},
	{
		pack : RU_2010_M_PACK_2,
		group : 'Егор Крид',
		song : "Самба белого мотылька (2019)"
	}
];
...
let ru_kish_karaoke_2 = [
	{
		type : `Не стало больше короля,<br/>
Все, как один, сошли с ума.<br/>
Летели месяцы, года`,
		line : "В веселом царстве карлика-шута",
		song : "Король и шут"
	},
	{
		type : `Странным был приказ,<br/>
Но все же в тот же час<br/>
Убийцу и мертвеца,`,
		line : "Их усадили там лицом напротив лица",
		song : "Два друга и разбойники"
	},
	{
		type : `Дровосек избегал все вокруг,<br/>
Никого не встретил он и вдруг –<br/>
Вдруг увидел дома на полу`,
		line : "В сапогах убитую сестру",
		song : "Сапоги мертвеца"
	},
	{
		type : `Проснувшись дома на полу,<br/>
Охотник в зеркало взглянул:<br/>
«О, как я сладко спал!»`,
		line : "Себе со смехом он сказал",
		song : "Охотник"
	},
	{
		type : `Бедного старика черт попутал,<br/>
Такого ему наговорил!<br/>
Много ли старому дураку надо,<br/>
Чтоб рассудок потерять!`,
		line : "К тому же он пьет как бык",
		song : "Паника в селе"
	},
	{
		type : `И отвечал ему палач:<br/>
«Мне честно, парень, жаль тебя.<br/>
Я знаю – ты не убивал,`,
		line : "Убийца потому что я",
		song : "Истинный убийца"
	},
	{
		type : `И волки среди ночи завыли под окном.<br/>
Старик заулыбался и вдруг покинул дом.<br/>
Но вскоре возвратился с ружьем на перевес:`,
		line : "Друзья хотят покушать, пойдем приятель в лес",
		song : "Лесник"
	},
	{
		type : `Возвращаясь домой, парень шёл по тропе.<br/>
Над долиной болот зависала луна.<br/>
И услышал он вдруг чей-то крик вдалеке,`,
		line : "И пошёл посмотреть, с кем случилась беда",
		song : "Помоги мне"
	},
	{
		type : `Слышишь, стерва, голос мой?<br/>
Ты ведь где-то рядом!<br/>
Не стучись ко мне домой,`,
		line : "Мне тебя не надо",
		song : "История о мертвой женщине"
	},
	{
		type : `А вот на сцену выбежал крутой ковбой –<br/>
Пол-зала расстрелял, потом покончил с собой.<br/>
Ужасный заяц громко прокричал: «Пожар!»`,
		line : "И, бросив факел в зал, со сцены убежал",
		song : "Кукольный театр"
	},
	{
		type : `И воскликнул здоровяк, руки потирая:<br/>
«Что ты хочешь мне сказать, я не понимаю».<br/>
И блеснул во мраке нож, и раздался хохот:`,
		line : "Прямо щас и прямо здесь будет тебе плохо",
		song : "Валет и дама"
	},
	{
		type : `Кто не пришел на праздник, кто не понял нас,<br/>
Кто в сундуке в подвале свой стерег алмаз,<br/>
И в чьих сердцах при виде нас рождалась злость,`,
		line : "Те навсегда исчезнут, сгинут в эту ночь",
		song : "Веселые тролли"
	},
	{
		type : `Вечерело, солнце опускалось,<br/>
Вячеслав заснул на гамаке.<br/>
Одолела мальчика усталость,`,
		line : "Кровь текла по раненой щеке",
		song : "Он не знает, что такое жить"
	},
	{
		type : `Вокруг отца плясали радостные дети:<br/>
Ах папа, ты для нас, ты лучше всех на свете!<br/>
Отец полез за маски эти расплатиться,`,
		line : "Но продавец куда-то резко испарился",
		song : "Отец и маски"
	},
	{
		type : `Но ей ответил парень:<br/>
«Нет я упрямый, упрямый!»<br/>
И с дубинкой в тот же миг`,
		line : "Вышел очень злой мужик",
		song : "Сказка про дракона"
	},
	{
		type : `Интерес ее был велик,<br/>
И инструмент она начала смотреть,<br/>
Нежно рукой гладить его,`,
		line : "Очень хотеть его тоже иметь",
		song : "Инструмент"
	},
	{
		type : `Уже накрыт огромный стол,<br/>
Зажарен чудный поросенок.<br/>
И славный тролль несет`,
		line : "Добротного пивца бочонок",
		song : "Собрание"
	}
];

let ru_kish_karaoke_3 = [
	{
		type : `Ты осталась с ним вдвоём,<br/>
Не зная ничего о нём.<br/>
Что для всех опасен он,`,
		line : "Наплевать тебе",
		song : "Кукла колдуна"
	},
	{
		type : `Мы смотрели очень долго друг на друга, чуть дыша,<br/>
К ней все ближе подходил я, не спеша,<br/>
Но толстяк с бородкой рыжей на дороге вдруг возник,`,
		line : "И она к нему помчалась в тот же миг",
		song : "Карапуз"
	},
	{
		type : `И к дереву она все ближе подходила,<br/>
Из луговых цветов плела себе венок,<br/>
И пальцем на воде она буквы выводила,`,
		line : "Ни слова разобрать, к сожалению, я не мог",
		song : "Наблюдатель"
	},
	{
		type : `Её лицо на время прояснилось:<br/>
«Я благодарна нашему врачу,<br/>
Он добрый, я в него почти влюбилась`,
		line : "И от него ребеночка хочу",
		song : "Бедняжка"
	},
	{
		type : `Гордо скину плащ, вдаль направлю взор.<br/>
Может, она ждёт? Вряд ли… это вздор.<br/>
И, издав дикий крик, камнем брошусь вниз.`,
		line : "Это моей жизни заключительный каприз",
		song : "Прыгну со скалы"
	},
	{
		type : `О, сколько их, готовых кровь отдать за наслажденье!<br/>
В них есть блаженство и любовь, как сон и пробужденье.<br/>
Но граф всегда один под леденящим сводом тьмы.`,
		line : "О смерти обожает видеть сны",
		song : "Девушка и граф"
	},
	{
		type : `– Я разных женщин посещаю,<br/>
И все милы по-своему они.<br/>
– Я не скупой, я угощаю,`,
		line : "Потом гуляем на твои",
		song : "Песня мушкетеров"
	},
	{
		type : `Мне не надо ничего, мне нужен лишь покой,<br/>
Точно знаю, почему я странный стал такой,<br/>
Я не то чтоб недоел, не то, что б недоспал,`,
		line : "Просто я от суеты и от непонимания устал",
		song : "Тяни"
	},
	{
		type : `Еще не пробудились петухи в деревнях,<br/>
И рыбаков на озере пока не видать,<br/>
Коровами истоптана трава на полях,`,
		line : "Как здорово, что здесь мне довелось побывать",
		song : "Утренний рассвет"
	},
	{
		type : `И с девчонкой любимой своей,<br/>
Мы расстались, увы, очень быстро,<br/>
Потому, что сказал кто-то ей:`,
		line : "Ты, Наташка, гуляешь с Сосиской",
		song : "Сосиска"
	},
	{
		type : `Он в них швыряет стулья, он ломает шалаши,<br/>
Он им грозится руки оторвать,<br/>
«Вы просто дьяволята, а никак не малыши!»`,
		line : "Но довели папашу, вашу мать",
		song : "Спятил отец"
	},
	{
		type : `Он копытками стучал,<br/>
По-ослиному кричал<br/>
И хвостом своим вертел –`,
		line : "Человеком быть хотел",
		song : "Ведьма и осел"
	},
	{
		type : `Знаете, что, разупрямая красотка,<br/>
Хватит уходом своим мне угрожать.<br/>
Если Вам нравится мерзкая погодка –`,
		line : "Можете плыть, а я просто лягу спать",
		song : "Екатерина"
	},
	{
		type : `Вместе с ней падал и я<br/>
Вывихнул руку, но это фигня.<br/>
Долго ее я жить умолял,`,
		line : "Арбузную корку я в сердцах проклинал",
		song : "Прерванная любовь, или Арбузная корка"
	},
	{
		type : `Тот ужасный крик всё звучал в ушах моих,<br/>
Но я всё дальше уезжал.<br/>
Что ж я натворил, я же человека сбил,`,
		line : "Но он проехать мне мешал",
		song : "Мотоцикл"
	},
	{
		type : `Когда проснешься ты, найдешь мои ботинки<br/>
Те, что случайно я оставил у тебя<br/>
А в чем ушел же он? Себя ты спросишь тихо.`,
		line : "В чем я ушел? И сам того не знаю я",
		song : "Забытые ботинки"
	}
];

let ru_kish_karaoke_4 = [
	{
		type : `Все выпил дед! – воскликнул кто-то сгоряча,<br/>
А после в ужасе попятился назад.<br/>
Невеста вздрогнула, в испуге бормоча:`,
		line : "А ведь он умер десять дней тому назад",
		song : "Дед на свадьбе"
	},
	{
		type : `Исчезновенье парня на селе<br/>
Родило в ней тревогу и печаль.<br/>
В тот день ее отец повеселел,`,
		line : "Пропавшего в лесу ему не жаль",
		song : "Запрет отца"
	},
	{
		type : `Разбирая свою печь,<br/>
Кузнец за нею увидал<br/>
Панцирь, латы, шлем и меч,`,
		line : "Драгоценным был металл",
		song : "Кузнец"
	},
	{
		type : `Я парень – будь здоров! В своих кругах.<br/>
Мне нельзя хамить и надо мной шутить,<br/>
Со мной нельзя играть!`,
		line : "Поверьте, я, как вы, умею обижать",
		song : "Разговор с гоблином"
	},
	{
		type : `Стоит графиня на картине,<br/>
Обнимает мужа своего.<br/>
И благородный граф вдаль взгляд направил свой,`,
		line : "И плачет бедный вор под его ногой",
		song : "Вор, граф и графиня"
	},
	{
		type : `И видит малыш как слепая старуха<br/>
Клюкой пригвоздила к стене мужика.<br/>
И как паренек богатырского духа`,
		line : "Под мышкой корову несет и быка",
		song : "Что видел малыш"
	},
	{
		type : `Жизнь – игра со смертью.<br/>
Где святость – там и грех!<br/>
И бил ее я плетью,`,
		line : "Хотя считал ее я лучше всех",
		song : "Невеста палача"
	},
	{
		type : `Преданный слуга улыбнулся тут:<br/>
Я любил всегда свой нелегкий труд.<br/>
По ночам сижу, за ножом слежу,<br/>
Фигурки вырезаю из костей,`,
		line : "С ремеслом дружу, обожаю гостей",
		song : "Мастер приглашает в гости"
	},
	{
		type : `И кровь стекает по лицу из ссадины на лбу.<br/>
Но почему привязан он веревками к столбу?<br/>
Ты не умрешь – сказал старик, затачивая нож.`,
		line : "Но парень опустил глаза, он понял – это ложь",
		song : "Бродяга и старик"
	},
	{
		type : `Нет сил, приятель, душа болит!<br/>
Быть может, пуля все повторит!<br/>
Наверно, я бы и поболтал…`,
		line : "Раздался выстрел – халдей упал",
		song : "Смерть халдея"
	},
	{
		type : `Не знал романтик, что она<br/>
Для любви не рождена.<br/>
И не безгрешен сам он был,`,
		line : "Он тоже мух когда-то бил",
		song : "Помнят с горечью древляне"
	},
	{
		type : `Как-то стали мужики<br/>
Спорить, кто из них мудрей.<br/>
Мимо старец проходил:<br/>
Тот умнее, – говорил,`,
		line : "У кого усы длинней",
		song : "Про Ивана"
	}
];

let ru_kish_karaoke_5 = [
	{
		type : `Меня готовы, как клопа топтать ногами.<br/>
И это значит – мой час пришел!<br/>
Открою вам один секрет –`,
		line : "Вельмож, к несчастью, честных нет",
		song : "Гимн шута"
	},
	{
		type : `Был дед да помер.<br/>
Слепой и жутко злой.<br/>
Никто не вспомнил`,
		line : "О нем с зимы холодной той",
		song : "Проклятый старый дом"
	},
	{
		type : `Но только она заснула,<br/>
Тихонько дверь притворив за собой,<br/>
В гостиную прошмыгнула`,
		line : "Фигура гостя во тьме ночной",
		song : "Тайна хозяйки старинных часов"
	},
	{
		type : `Веревкой за ноги подвешен был Кузьма,<br/>
Сильно у него болела голова<br/>
Из пересохшего рта вырвались слова:`,
		line : "Брага где?! Что за дела?!",
		song : "Кузьма и барин"
	},
	{
		type : `От гнева вздулись вены офицера,<br/>
Вонзил кинжал он в шею флибустьера.<br/>
Уронив бутылку, на песок старик свалился`,
		line : "А из раны вместо крови крепкий ром полился",
		song : "Пират"
	},
	{
		type : `На скотном дворе начиналось утро!<br/>
Доярка спешила коров подоить,<br/>
В коровнике было тепло и уютно.`,
		line : "Скотине хотелось поесть и попить",
		song : "Скотный двор"
	},
	{
		type : `Будешь писать ты про меня,<br/>
И будешь мне служить Вечно! Вечно!<br/>
Как не ушёл я от огня,`,
		line : "Ты не скроешся от ветра",
		song : "Возвращение колдуна"
	},
	{
		type : `Его к осине привязал, но тот был слишком ловкий.<br/>
«Болван!» – папаше он сказал и вылез из веревки.<br/>
К утру мужик пришел домой, принес клыки злодея`,
		line : "Бить зубы было не впервой – хорошая идея",
		song : "Зловещий кузен"
	},
	{
		type : `Луна. Ты не спишь.<br/>
За мной ты следишь.<br/>
То, что слышу я, ты услышь!`,
		line : "Уничтожь, прошу, все эти звуки",
		song : "Ответ лютая месть"
	},
	{
		type : `Здравствуй, дядя,<br/>
На тебя я глядя<br/>
Не могу понять,<br/>
Для чего в ночи`,
		line : "На мосту стоять",
		song : "Рогатый"
	},
	{
		type : `Кричала баба: Твой пацан – урод,<br/>
Что подумает о нас народ!?<br/>
Тут дед слезу уронил.`,
		line : "Выпил, снова налил",
		song : "Двухголовый отпрыск"
	},
	{
		type : `«Меня ты не удивил и не такое я видал!»<br/>
В дом я вернулся и обалдел –<br/>
Там с кружкой чая гость мой сидел.`,
		line : "Его увидел я и рядом с ним себя",
		song : "Два монаха в одну ночь"
	},
	{
		type : `У каменной стены, на сырой земле<br/>
Молча я сижу и тоскливо мне.<br/>
Палкой по спине получил вчера,`,
		line : "Шлепнули меня будто комара",
		song : "Кто это все придумал"
	},
	{
		type : `Сувенир теперь моя голова –<br/>
Гладкий череп – в нем живые глаза<br/>
Замечательная пепельница,`,
		line : "много денег стоит она",
		song : "Пивной череп"
	},
	{
		type : `«Я не согласен дед с тобою, тем мы квиты,<br/>
Что испугав тебя – я сам упал в овраг!<br/>
Иди ты к лешему!» – воскликнул он сердито.<br/>
И леший понял – `,
		line : "этот парень не дурак",
		song : "Парень и леший"
	},
	{
		type : `Он бы разозлился,<br/>
За наган схватился<br/>
И разревелся он бы сам`,
		line : "Стреляя по слезам",
		song : "Похороны панка"
	},
	{
		type : `Вот несет одна мне свои цветы,<br/>
Вот стоит другая, погруженная в мечты.<br/>
Я пытался их до смерти рассмешить,<br/>
Но пришлось,`,
		line : "как в старой сказке, просто задушить",
		song : "Воспоминания о былой любви"
	}
];

let ru_kish_karaoke_6 = [
	{
		type : `Теперь я знаю – у чертей полно идей!<br/>
Коварством, хитростью свой опыт добывают.<br/>
Но хуже нам, когда среди людей`,
		line : "У них сообщники бывают",
		song : "Волосокрад"
	},
	{
		type : `Что за наважденье без предупрежденья<br/>
А вот так напали – сильно напугали<br/>
Смеялись и толкались, парнишку заставляли`,
		line : "Пого танцевать",
		song : "Мертвый анархист"
	},
	{
		type : `Вскочил пацан и следуя совету:<br/>
Смеяться глупо стал, ума как будто нету.<br/>
От этих звуков дед умчался на тот свет,`,
		line : "Оставив на земле смешной совет",
		song : "Смешной совет"
	},
	{
		type : `Полна страданий жизнь моя,<br/>
Но выбор сделанный судьбой<br/>
Нет, изменить не в силах я:`,
		line : "Война с самим собой",
		song : "Некромант"
	},
	{
		type : `В гости ко мне мало кто заходит.<br/>
Все же на обед выгоды мне нет<br/>
Кушать тебя –`,
		line : "люди мне приелись",
		song : "Зашитник свиней"
	},
	{
		type : `Генрих растерянный поднял взгяд,<br/>
Не привык слышать он слово «мат».<br/>
В гневе он был от того,`,
		line : "Что пешкою свергли его",
		song : "Генрих и Смерть"
	},
	{
		type : `Но та тревожно в сторону леса поглядела.<br/>
Волков почуяла, – смекнул, тот час же дед.<br/>
Скачи галопом, коли жить не надоело,`,
		line : "Пока не выскочил лохматый наш сосед",
		song : "Жаль, нет ружья"
	},
	{
		type : `Но больная голова,<br/>
Мне все портить начала.<br/>
И теперь представил я,`,
		line : "Будто свергнули меня",
		song : "Представляю я"
	},
	{
		type : `Мой характер был непрост,<br/>
В силу ум ушел и в рост,<br/>
Но такой уж был мой нрав –`,
		line : "Драться с теми, кто не прав",
		song : "Мой характер"
	},
	{
		type : `Ты уж, собачка, не брани,<br/>
Я бы не стал тебе мешать,<br/>
Мне просто некуда идти,`,
		line : "К тому же очень трудно встать",
		song : "Песенка пьяного деда"
	},
	{
		type : `Вскоре очень злой вылез водяной:<br/>
Ты что, лопух, совсем, мужик, опух?<br/>
Я в своем пруду таких не потерплю,`,
		line : "Еще увижу – сразу утоплю",
		song : "Водяной"
	},
	{
		type : `И ничего вдова поделать не могла,<br/>
Шепнула Иоганну, что разденется сама.<br/>
Твоя, горбун, взяла, – слукавила она,`,
		line : "Рукой нащупав в сене ручку топора",
		song : "Вдова и Горбун"
	},
	{
		type : `В их появленьи был бесхитростный расчет:<br/>
Мы людям принесем вино,`,
		line : "они же нам дадут за это мед",
		song : "Вино хоббитов "
	},
	{
		type : `Вдруг Косой вскочил со стула –<br/>
Пуля-дура виновата –<br/>
На Гуся направил дуло,`,
		line : "А пристрелил родного брата",
		song : "Разборки из-за баб"
	},
	{
		type : `Как тучи небо закрывают<br/>
И не видно им конца.<br/>
Раскаты грома вызывают`,
		line : "Из речки тело мертвеца",
		song : "Утопленник"
	},
	{
		type : `Я был медведем, проблем не знал.<br/>
Зачем людских кровей я стал?<br/>
И оборвется тут словно нить,`,
		line : "Мой дар - на двух ногах ходить",
		song : "Медведь"
	},
	{
		type : `Сегодня не пойдем буянить по дороге,<br/>
Тем более, что нас не держат наши ноги!<br/>
И песню затянув да голосами пьяными,`,
		line : "Здесь, в поле, мы останемся ждать восход румяный",
		song : "Пьянка"
	}
];

let ru_kish_karaoke_7 = [
	{
		type : `Если же в бою ты поймал кураж,<br/>
Хэй! Хой! Хэй! – Зарубаешь гранж!<br/>
А как только враг помчится наутёк,`,
		line : "Веселись, зарубай панк-рок",
		song : "Хардкор по-русски"
	},
	{
		type : `Молва ходила, будто дед крутой гипнотизер,<br/>
Из любопытных наших душ он все святое пёр,<br/>
Он не по дням, а по часам жирел и богател,`,
		line : "Теперь у сельских мужиков он жен забрать хотел",
		song : "Волшебный глаз старика Алонса"
	},
	{
		type : `Я к людям добрый, злобы нет,<br/>
Откуда злобе взяться?`,
		line : "Ведь для меня они обед",
		song : "Исповедь вампира"
	},
	{
		type : `Он хорош был в бою, а после изнасиловал свинью,<br/>
Ржали все, как один,`,
		line : "за это он и отомстил, кретин",
		song : "Месть Гарри"
	},
	{
		type : `Воинов замученных ждут холода,<br/>
Северный флот идет в никуда,<br/>
Богом забыта эта земля,`,
		line : "Враг будет плакать – все было не зря",
		song : "Северный Флот"
	},
	{
		type : `Встали все они на его пути,<br/>
– Посмотрите! Олоф к нам явился, во плоти!<br/>
Это лицезреть всем нам довелось,`,
		line : "Древнее пророчество сбылось",
		song : "Идол"
	},
	{
		type : `Голос из каюты прозвучал;<br/>
«Веселей, ребята!<br/>
Наша песня свята!`,
		line : "В бухту заходи, ищи причал",
		song : "Бунт на корабле"
	},
	{
		type : `На французской мы земле гостили –<br/>
Сталью угощали нас,<br/>
За четыре дня меня убили`,
		line : "Девять или десять раз",
		song : "Хороший пират – мертвый пират"
	},
	{
		type : `Мы из дурки ночью убежали,<br/>
Я и мой приятель – Леня де Сад,<br/>
Хоть друг друга сильно уважали,`,
		line : "Расставаться с ним был я рад",
		song : "Рыцарь"
	},
	{
		type : `Если ты желаешь говорить со мною долго,<br/>
Каждая копеечка вложена с толком!<br/>
Нет, заплати, а потом со мною говори!<br/>
Что «але»? Куда иди?!`,
		line : "Говори скорее, воду не мути",
		song : "Звонок"
	},
	{
		type : `Но признаться я могу лишь себе одному!<br/>
Их страданья – тщеславию дань моему,<br/>
Каждой ночью истязаю кнутом свою плоть,`,
		line : "Только похоть я никак не могу побороть",
		song : "Инквизитор"
	},
	{
		type : `Задира рухнул, не издав ни звука,<br/>
Солдат, качаясь, к выходу пошел,<br/>
– Да, жизнь – дерьмо! Не жизнь, а просто скука!`,
		line : "Зато хоть собеседника нашел",
		song : "Задира и солдат"
	},
	{
		type : `Своих я вижу праотцов<br/>
С кого пример всегда я брал<br/>
Героев, чёрт бы их побрал,`,
		line : "Крутых, отчаянных бойцов",
		song : "Раненый воин"
	},
	{
		type : `Заклинанием плоть вызываю свою<br/>
Всё того же охотника в ней узнаю<br/>
И зелёная кровь оживляет её,`,
		line : "Только сердце стучит уже не моё",
		song : "Хозяин леса"
	}
];

let ru_kish_karaoke_8 = [
	{
		type : `Актёр-лицедей,<br/>
Добряк и злодей,<br/>
Не ради людей,`,
		line : "А ради искусства",
		song : "Марионетки"
	},
	{
		type : `Всему виной один лишь факт –<br/>
Зловещий Дьявольский контракт<br/>
И мне и Вам не повезло:`,
		line : "Под маской обитает зло",
		song : "Маска"
	},
	{
		type : `– Что ты гостям суёшь?<br/>
Шахматы и лото?<br/>
Нас ты не проведёшь!`,
		line : "Трактирщик ты или кто",
		song : "Ром"
	},
	{
		type : `Что-то по-латыни резко он сказал,<br/>
Гробы открылись в полумгле.<br/>
В сторону мою рукой он указал,`,
		line : "И тени двинулись ко мне",
		song : "Гробовщик"
	},
	{
		type : `Знаю я, что любовь такая<br/>
Не увенчается успехом.<br/>
Ах, была бы она другая,`,
		line : "Я б стал нормальным человеком",
		song : "Дочка вурдалака"
	},
	{
		type : `Ненавижу я<br/>
Этих маньяков!<br/>
Одолеть меня<br/>
Не смог ни один`,
		line : "Из моих учеников",
		song : "Свой среди чужих"
	},
	{
		type : `Злоба меня лютая гложет,<br/>
Разум судьбу понять не может;<br/>
Против меня`,
		line : "Восстала сущность моя",
		song : "Отражение"
	},
	{
		type : `И художника русалка<br/>
Нежно за руку взяла,<br/>
Одурманив его взглядом,`,
		line : "Вдруг под воду увела",
		song : "Та, что смотрит из пруда"
	},
	{
		type : `Всё, что в огороде,<br/>
По пути сосед нарвал,<br/>
Выложил на стол,`,
		line : "Настойку горькую достал",
		song : "В гостях у соседа"
	},
	{
		type : `Палец на курок,<br/>
Из ствола дымок<br/>
Ты, приятель – вор!`,
		line : "Кончен разговор",
		song : "Хозяин таверны"
	},
	{
		type : `Я становиться вашей жертвой не желаю!<br/>
Со мною, Гудвин, ваши штучки не пройдут!<br/>
И цель свою я очень чётко понимаю:`,
		line : "Вас самого, писатель Гудвин, скоро не найдут",
		song : "Писатель Гудвин"
	},
	{
		type : `Лишь я в Джокера попал,<br/>
Как соперник мой упал.<br/>
Между глаз вошёл свинец –`,
		line : "Мне и ему конец",
		song : "Джокер"
	},
	{
		type : `Усопший был танцором,<br/>
За семьдесят не наплясался лет,<br/>
И тут с внучком Егором`,
		line : "Любимый повторял свой пируэт",
		song : "Пляски на могиле"
	},
	{
		type : `На меня нет управы,<br/>
У меня есть двустволка.<br/>
Без сомненья, вас`,
		line : "Мой заметит глаз",
		song : "Матерый волк"
	},
	{
		type : `Но всё равно –<br/>
Нет, не пал духом я!<br/>
Подворотня моя`,
		line : "Как театр для меня",
		song : "Продавец кошмаров"
	},
	{
		type : `И нет эмоций никаких,<br/>
Лишь память направляет их.<br/>
Заполонили улицы`,
		line : "Живые мертвецы",
		song : "Город мертвецов"
	}
];

let ru_kish_karaoke_10 = [
	{
		type : `До капли выжму вас.<br/>
И даже в смертный час,<br/>
Отринув боль –`,
		line : "Примите роль",
		song : "Театральный демон"
	},
	{
		type : `Что не убивает –<br/>
Делает сильней!<br/>
Если же судьба со мной играет –`,
	...
	{
		type : `Но в один момент<br/>
Ужаснется свет,<br/>
Лишь узнав о том,`,
		line : "Что подвохов нет",
		song : "Фокусник"
	},
	{
		type : `Подсыпать в душу яд<br/>
Всегда он рад.<br/>
Всего за час`,
		line : "Прочтет он вас",
		song : "Танец злобного гения"
	},
	{
		type : `И опять в своей манере<br/>
Он, стереотипы ломая, шокирует зал.<br/>
Да! Он лучший в этой сфере!`,
		line : "Весьма необычный сценический образ создал",
		song : "Энди Кауфман"
	},
	{
		type : `И никогда не увидим мы вас,<br/>
Завтра последний выход у нас.<br/>
Яма глубокая ждет во дворе.`,
		line : "До одного всех поставят к стене",
		song : "Мадам Жоржетт"
	},
	{
		type : `Протест – объективен, успех наш – возможен,<br/>
И каждый, кто травит нас – будет низложен.<br/>
И те, кто всегда отдают здесь приказы,`,
		line : "Безумны не меньше – заметил я сразу",
		song : "Бунтарь"
	},
	{
		type : `Той жизни не помню, все как во мгле,<br/>
И это порою нравится мне.<br/>
Отныне изгоем быть не с руки,`,
		line : "Повсюду со мною ученики.",
		song : "Темный учитель"
	},
	{
		type : `Френч зла и сапоги.<br/>
Творит, но не за деньги,<br/>
Великий портной коварной рукой.`,
		line : "Шито все черной иглой",
		song : "Король вечного сна"
	},
	{
		type : `А теперь взгляните на других:<br/>
Чем, скажите, я смешнее их?<br/>
Если маску снять с любого тут –`,
		line : "Станет ясно, кто из нас здесь шут",
		song : "Бал лицемеров"
	},
	{
		type : `У огромного костра<br/>
До краев она им нальет вина,<br/>
Зачарованы,<br/>
...
function mode(num, album, album_num){
	...
	if(num == 33){
		...
		$('#total').html(songs.length);
		learn = learnKaraoke;
		choose = chooseKaraoke;
		finalMessage = ' Ура! Вы освоили караоке: КиШ "' + album + '"!';
		shuffle(songs);
		toggleLearn();
		mirror('Альбом "' + album + '". Напишите следующую строчку!', 10, 'blue');
	}
	// КиШ реверс
	if(num == 34){
		$('#back').hide();
	...
	if(num == 35){
		...
		$('.kish_revers').hide();
		year = 'kish';
		finalMessage = ' Ура! Вы освоили реверсы: КиШ "' + album + '"!';
		setMedia = setRevers;
		$('#learn').html('Угадай песню КиШа по реверсу');
		songs = generatePathsBySongName(eval('ru_kish_gr_' + album_num), 'audio/ru_kish_gr/revers/' + album + '/', 'img/ru_kish_gr/avatar/');
		$('#total').html(songs.length);
		answers = songs.map(item => item.group);
		shuffle(songs);
		toggleLearn();
